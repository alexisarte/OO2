...
class DirectorioTest {
    ...
    void testArchivoMasGrande() {
        ...
        assertEquals(backup2015.tamanoTotalOcupado(), conSubdirectorios.archivoMasGrande().tamanoTotalOcupado());
    }
    ...
    void testArchivoMasNuevo() {
        ...
        assertEquals(backup2015.getNombre(), conSubdirectorios.archivoMasNuevo().getNombre());
    }
